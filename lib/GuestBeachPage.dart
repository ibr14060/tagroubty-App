...
class GuestBeachPage extends StatefulWidget {
  const GuestBeachPage({Key? key, required this.title});

  final String title;

  @override
  State<GuestBeachPage> createState() => GuestBeachPageState();
}

class GuestBeachPageState extends State<GuestBeachPage> {
