...
class GuestMuseumPage extends StatefulWidget {
  const GuestMuseumPage({Key? key, required this.title});

  final String title;

  @override
  State<GuestMuseumPage> createState() => GuestMuseumPageState();
}

class GuestMuseumPageState extends State<GuestMuseumPage> {
