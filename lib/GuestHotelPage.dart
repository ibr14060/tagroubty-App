...
class GuestHotelPage extends StatefulWidget {
  const GuestHotelPage({Key? key, required this.title});

  final String title;

  @override
  State<GuestHotelPage> createState() => GuestHotelPageState();
}

class GuestHotelPageState extends State<GuestHotelPage> {
