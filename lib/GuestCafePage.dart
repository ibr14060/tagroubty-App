...
class GuestCafePage extends StatefulWidget {
  const GuestCafePage({Key? key, required this.title});

  final String title;

  @override
  State<GuestCafePage> createState() => GuestCafePageState();
}

class GuestCafePageState extends State<GuestCafePage> {
